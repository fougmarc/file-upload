  ...
  <b-container>
    ...
    <b-card bg-variant="light">
      <b-form-file v-model="selFile"
                   ref="form"
                   placeholder="Mettre le fichier..."/>
      <b-button variant="primary" @click="submitFile()">
        Envoyer &nbsp; &nbsp;<font-awesome-icon icon="upload" /></b-button>
    </b-card>
    ...
    <b-card bg-variant="light">
      <b-row>
        <b-col col="4"><b-button variant="danger" @click="deleteFile()">
          Supprimer &nbsp;&nbsp;<font-awesome-icon icon="trash-alt" /></b-button>
        </b-col>
        <b-col cols="4" md="auto">
          <b-card bg-variant="light" v-if="status">
            <b-card-text style="margin-right: 50px;">
              <strong>{{ selectedDataSizes.length }}</strong> Fichier selectionné</b-card-text>
            <b-card-text>Taille totale: <strong>{{ selectedDataTotal }}</strong></b-card-text>
          </b-card>
        </b-col>
      </b-row>
